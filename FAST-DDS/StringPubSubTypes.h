...
#ifndef _STD_MSGS_MSG_STRING_PUBSUBTYPES_H_
#define _STD_MSGS_MSG_STRING_PUBSUBTYPES_H_
...
#error Generated String is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
namespace std_msgs
{
    namespace msg
    {
         ...
         * @ingroup STRING
         */
        class StringPubSubType : public eprosima::fastrtps::TopicDataType {
        public:
            typedef String type;
...
#endif // _STD_MSGS_MSG_STRING_PUBSUBTYPES_H_